...
export default function Home({ blogs, web_desc, message }) {
  ...
  return (
    <section className="text-gray-600 body-font min-h-screen">
      {!message ? (
        <>
          <main className={`relative my-0 mx-auto max-w-[100vw] flex justify-center flex-col min-h-[100vh] items-center z-10 before:absolute before:top-0 before:left-0 before:h-full before:w-full before:bg-[url(../public/main-bg.jpg)] before:dark:bg-[url(../public/main-bg-dark.jpg)] before:object-center before:bg-cover before:opacity-80 before:-z-10`}>
